...
DATASETS=(
  "Simulated[X_density=1.0,n_features=100,n_samples=10000,rho=0.5,n_signals=50]"
  "Simulated[X_density=1.0,n_features=20000,n_samples=200,rho=0.8,n_signals=10]"
  "Simulated[X_density=0.001,n_features=200000,n_samples=2000,rho=0.0,n_signals=50]"
  "libsvm[dataset=bcTCGA,standardize=True]"
