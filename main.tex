...
\begin{description}
  ...
  \item[ADMM] The alternating direction method of
        ...
        may lead to erratic convergence behavior in practice. We use the \fct{lsqr}
        solver from \pkg{SciPy}~\citep{virtanen2020} to solve the linear system if
        \(\min\{n, p\} > \num{1000}\) and otherwise use the factorizations
  ...
  \item[Newt-ALM] A semi-smooth Newton-based method~\citep{luo2019}. Our
        ...
        a bug fix for the Woodbury-based solver.
