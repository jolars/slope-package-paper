...
\begin{figure}[t]
  \centering
  \subcaptionbox{The SLOPE path}{\includegraphics[width=\natwidth]{images/diabetes-slope.pdf}}
  \subcaptionbox{The lasso path}{\includegraphics[width=\natwidth]{images/diabetes-lasso.pdf}}
  \caption{%
