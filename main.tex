...
formulation, where rows of the coefficient matrix can be arbitrarily shifted
without changing the value of \(F\). This also means that
...
the situation is much trickier problem since, then, shifting the rows of the coefficient
matrix can affect the penalty due to its inseparability.
