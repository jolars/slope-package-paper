...
We fit the result in \Cref{fig:relaxed-slope}. The path is no longer smooth and
changes dramatically depending on the current cluster structure.
...
which displays the optimal values for all the cross-validated paramters.
