...
See \Cref{sec:solver-details} for more details on the solvers and their
...
\begin{figure}[tp]
  ...
  \caption{%
    ...
    different real data sets~(\Cref{tab:real-data}) and three levels of
...
same algorithm, except that the current implementation faress even better. We
